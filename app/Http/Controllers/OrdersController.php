...
class OrdersController extends Controller
{
    ...
    function showOrdersDashboard()
    {
        ...
        $orders = DB::select("select order_details.total,menus.name from order_details inner join orders on order_details.order_id=orders.id inner join menus on menus.id = order_details.product_id ");
