<div>
    ...
    <div  style="border-left: solid 1px rgba(0,0,0,0.1);height: 100%" class="px-6 my-6 sidebar">
        ...
        <div>
            ...
            <div class="flex justify-between mx-2  flex-wrap">
                ...
                <div style="background-color: rgba(230,96,1,0.2);width: 9rem;"
                    ...
                    <i class="fa-solid fa-list-1-2 fa-xl my-5"></i>
                ...
                <div style="background-color: rgba(230,96,1,0.2);width: 9rem;"
                     class="m-5 p-5 rounded-3xl bg-white shadow-lg	hover:shadow-2xl flex justify-between flex-col text-center">
                    <i class="fa-solid fa-users fa-xl my-5"></i>
                ...
                <div style="background-color: rgba(230,96,1,0.2);width: 9rem;"
                     class="m-5 p-5 rounded-3xl bg-white shadow-lg	hover:shadow-2xl flex justify-between flex-col w-36 text-center">
                    <i class="fa-solid fa-shopping-cart fa-xl my-5"></i>
                ...
                <div style="background-color: rgba(230,96,1,0.2);width: 9rem;"
                     class="m-5 p-5 rounded-3xl bg-white shadow-lg	hover:shadow-2xl flex justify-between flex-col w-36 text-center">
                    <i class="fa-solid fa-utensils fa-xl my-5"></i>
