...
<body style="background-image: linear-gradient(to right, rgba(179,139,103,0.6),rgba(255,253,237,0.5), rgba(179,139,103,0.6));">
    ...
    <div id="menu" style="border-top: solid 2px rgba(0,0,0,0.05)">
        ...
        <div class="row" style="margin: 0 50px">
            @foreach($menus as $menu)
                <div class="col-4 image-container" style="cursor: pointer">
